...
[role="lead"]
觀看影片和演示，了解 VMware 與NetApp儲存解決方案的整合。了解如何使用NetApp ONTAP Tools for VMware vSphere、SnapCenter Plug-in for VMware vSphere、3-2-1 資料保護，以及NetApp如何與 VMware Cloud Foundation 和 VMware vSphere Foundation 協同工作。
