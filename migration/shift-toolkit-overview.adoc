...
* 使用虛擬化遷移工具包 (MTV) 將 VMware ESXi 遷移到 Red Hat OpenShift Virtualization
* VMware ESXi 到 Proxmox VE
...
Shift 工具包可以下載link:https://mysupport.netapp.com/site/tools/tool-eula/netapp-shift-toolkit["這裡"]僅適用於 Windows 系統。
