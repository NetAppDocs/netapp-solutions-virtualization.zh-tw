...
要開始使用Data Infrastructure Insights，您可以在以下位置註冊：link:https://www.netapp.com/forms/dii-free-trial/["Data Infrastructure Insights免費試用"] 。詳情請參閱 link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Data Infrastructure Insights入職"]
