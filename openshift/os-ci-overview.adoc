...
要開始使用Cloud Insights，您必須在 link:https://www.netapp.com/console["NetApp Console"]。有關詳細信息，請參閱 link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Cloud Insights入門"]
