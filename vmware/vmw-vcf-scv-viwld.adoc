...
TIP: 除了將使用 SCV 進行的備份複製到輔助儲存之外，還可以使用NetApp Backup and Recovery for VMs 將資料異地副本複製到三大 (3) 領先雲端提供者之一的物件儲存中。更多資訊請參閱此產品/服務介紹。link:https://docs.netapp.com/us-en/data-services-backup-recovery/index.html["NetApp Backup and Recovery文檔"] 。
